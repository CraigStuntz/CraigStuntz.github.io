...
Much easier to solder than the power supply. 
## 

One kind of funny ommission from the instructions: For whatever reason, one of 
...
* Caps, resistors, and diodes at main power input
* Resistors at output
