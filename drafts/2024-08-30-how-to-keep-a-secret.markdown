...
if we can do better. Azure Key Vault has 
[a way to shim this over environment access which is very convenient](https://learn.microsoft.com/en-us/azure/app-service/app-service-key-vault-references?tabs=azure-cli). Using this method
